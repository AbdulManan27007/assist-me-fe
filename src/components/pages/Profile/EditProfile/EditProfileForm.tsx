...
export function EditProfileForm() {
  ...
  if (isUserLoading)
    return (
      <div className="grid gap-4 p-6 border border-[#0000001A] rounded-[12px_12px_0_0]">
      <div className="relative w-24 h-24">
        <Skeleton circle height={96} width={96} />
        <div className="absolute bottom-0 right-0 bg-orange-500 p-2 rounded-full shadow-md">
